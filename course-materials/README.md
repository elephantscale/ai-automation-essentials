...
Reusable classroom assets for AI Automation Essentials.
...
`cohort-intros.html` is a single self-contained page (no build step, no backend). Two ways
to use it:

- **Local:** download the file and open it in any browser.
- **Hosted (GitHub Pages):** if Pages is enabled for this repo, share this link —
  `https://elephantscale.github.io/ai-automation-essentials/course-materials/cohort-intros.html`

For this cohort, students open it inside their ProTech lab desktop (Firefox), fill it in, and
paste the card into the class chat — a fast, low-pressure way to introduce themselves.
