...
The conversation about AI at work has moved past "write me a better
email." Organizations are now wiring AI into their actual workflows ---
...
-   **Governance that reflects 2026.** Responsible AI grounded in real
    ...
    "bias."
-   **Tied to business value.** ROI modeling, adoption and change
    management, and a 30-day action plan make the case to leadership.
-   **You leave with assets.** Reusable prompt templates, workflow
    recipes, evaluation rubrics, and an ROI worksheet.

## Audience

-   Business professionals who want to understand and apply AI
...
-   Basic keyboard and browser proficiency (typing, copy/paste,
    navigating web apps)
-   No programming, data-science, or prior AI experience required

## Objectives

By the end of the course, participants will be able to:

-   Explain what generative AI is (and isn't), how it works, and where
    it fits in business operations
-   Use key terms fluently: models, context, tokens, prompts,
    hallucinations, agents, tool use, bias
-   Identify high-value workflows suitable for AI automation --- and
    ones that are not
-   Write clear, structured prompts, including multi-step chains that
...
-   Calculate time saved, error reduction, and ROI for department-level
    AI use cases

## Delivery Model

-   2 training days, 8 hours per day
-   Lecture, live demonstration, and hands-on labs split roughly 50/50
-   Modules build from foundations through prompting, automation,
    decisions, governance, and ROI to a capstone
...
# Module 1 --- Foundations of Generative AI in Business

**Suggested duration:** 2 hours

**Learning outcomes:**

-   Explain what generative AI is and how it differs from rules-based
    automation

-   Use core AI terminology accurately

-   Recognize where AI fits --- and where it doesn't --- in business
    operations

-   What generative AI is (and isn't), and how it works at a practical
    level

-   Key terms without the jargon: models, context, tokens, prompts,
    hallucinations, bias
...
-   Introduction to AI operations for business leaders

**Hands-on Lab:** Compare an AI assistant against a rules-based approach
on the same task and identify where each wins.

**Module review:** Spot three workflows in your own department where AI
...
-   Write clear, structured prompts that produce reliable, reusable
    output

-   Build multi-step prompt chains

-   Produce structured output that downstream tools can consume

-   The anatomy of a strong prompt: role, task, context, constraints,
    format, examples

-   Role-based prompts with constraints for consistent, on-brand results

-   Advanced prompting: chains and multi-step tasks

-   Structured output (lists, tables, JSON-like formats) that feeds an
    automation

-   Giving the model reference material so answers are grounded, not
    guessed
...
# Module 3 --- Evaluating & Troubleshooting AI Output

**Suggested duration:** 2 hours

**Learning outcomes:**

-   Define what "good" output looks like and evaluate against it

-   Detect inaccuracies and untrustworthy responses

-   Diagnose and fix common prompt and output failures

-   Defining AI success: accuracy, completeness, tone, structure,
    trustworthiness

-   Spotting inaccuracies and hallucinations before they cause harm

-   Common failure modes: ambiguity, hallucination, and prompt injection

-   Guardrails: constraining what an AI is allowed to do

-   Troubleshooting a failing prompt or workflow

**Hands-on Lab:** Evaluate AI output against a rubric, then troubleshoot
...
-   From automation to agent: AI that can use tools and take multi-step
    actions

-   Tool-connected assistants and the idea behind open standards like
...
-   Understand the limits of AI-assisted analysis

-   Summarizing and extracting from documents, transcripts, and reports
...
-   Apply ethics, privacy, and security practices to AI use

-   Recognize regulatory obligations that shape AI adoption

-   Judge when not to use AI

-   Ethics, bias, and fairness in business AI

-   Privacy, confidentiality, and data security: what not to paste into
    a prompt

-   Security threats: prompt injection, data leakage, and untrusted
    content

-   When *not* to use AI: risks, high-stakes decisions, and required
    human oversight

-   The regulatory landscape: EU AI Act and the NIST AI Risk Management
...
-   Calculate the cost and ROI of an AI use case
...
-   Measuring impact: time saved, error reduction, and ROI
